...
// 仅标记内置工具及它捕获的目录,避免设置操作覆盖同名扩展工具。
const catalog = Symbol("skill catalog");
export function skillCatalog(tool: Tool): readonly Skill[] | undefined {
  return (tool as Tool & { [catalog]?: readonly Skill[] })[catalog];
}
  ...
  return Object.assign(
    defineTool({
      ...
      parameters: Type.Object({
        ...
        args: Type.Optional(
          Type.String({ description: "arguments for the skill, if it takes any" }),
        ),
      }),
